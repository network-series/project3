	...
	export default { 
		...
		methods: {
		    ...
		    startReg() {
				...
				if (this.passData != this.passDataVertify) {
				    uni.showToast({
				        icon: 'none',
						position: 'bottom',
				        title: '密码不匹配'
				...
				console.log("注册成功")
				this.reginfo.usrID=this.phoneData
				this.reginfo.password=this.passData
...
.backbtn{
	...
	width:150upx;
	height:100upx;
	background:linear-gradient(to right, rgba(233,23,12,0), rgba(255, 255, 255, 153));
